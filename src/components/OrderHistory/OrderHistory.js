          ...
          return (
            ...
            >
              ...
              <div className="col-md-8 border-left desc-col d-flex align-items-center">
                <div className="item-desc mt-2" style={{ minHeight: "70px" }}>
                  <div className="d-flex">
                    <h4 className="title text-uppercase">
                      {order.product.description1}
                    </h4>
                    <p className="ml-3">({order.product.second_item_number})</p>
                  </div>
                  <div>
                    <div className="d-flex flex-wrap justify-content-between">
                      ...
                      <div className="add-remove">
                        <span className="mx-3 mb-4">
                          <b className="mr-1">Ilość zamówiona/dostarczona:</b>
      ...
      <div className="container-fluid p-5">
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="order-list ml-1">Lista Twoich zamówień:</h4>
          </div>
        </div>
        <div className="row">
