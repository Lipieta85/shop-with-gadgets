              ...
              <div>
                <div className="d-flex flex-wrap justify-content-between">
                  <div>
                    <b>
                      Cena:{" "}
                      <span className="order-text-value">{item.price} zł</span>
                    </b>
                  </div>
                  <div className="add-remove">
                    <span className="mx-3 mb-4">
                      <b>Ilość: </b>
                      <b className="order-text-value">{item.quantity}</b>
                    </span>
                  </div>
                  <div className="add-remove">
  ...
  return (
    <div className="order-summary">
      <div className="container">
        ...
        <hr />
        <div className="d-flex flex-wrap justify-content-between">
          <Link to="/Basket" className="btn btn-outline-primary mr-1 mt-4">
            Wróć do koszyka
          </Link>
          <Link
            to="/OrderEnd"
